        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6">
                <form action="{{ route('report.user.submit', $user->id) }}" method="POST">
                    ...
                    {{-- Reason Dropdown --}}
                    <div class="mb-4">
                        <label for="preset_reason" class="block font-medium text-gray-700 dark:text-gray-200">
                            Select a reason
                        </label>
                        <select id="preset_reason" name="preset_reason"
               ...
               bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="custom_reason" name="custom_reason"
                            rows="4"
                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm
